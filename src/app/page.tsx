      ...
      <div className="flex flex-col w-full h-full mb-10 justify-center">
        ...
        <div className='w-full md:grid md:grid-cols-2'>
          ...
          <div className='flex flex-col md:mr-5 items-center max-w-[1000px]'>
            <TaskListWrap completeDateFilter={null} typeFilter={['List']} title="Quick List" />
            <TaskListWrap completeDateFilter={null} typeFilter={['Task']} dueDateFilter={today} isOpen={true} title="Today's Tasks" />
            <TaskListWrap completeDateFilter={null} typeFilter={['Task']} dueDateFilter={tomorrow} title="Tomorrow's Tasks" />
          </div>
          <div className='flex flex-col md:ml-5 items-center max-w-[1000px]'>
            <TaskListWrap completeDateFilter={null} typeFilter={['Event']} dueDateFromFilter={today} title="Upcoming Events" />
            <Routines/>
          </div>
        </div>
      </div>
