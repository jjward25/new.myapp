  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-4 md:px-24 md:pt-12 w-full h-full">
      ...
      <div className="flex flex-col w-full h-full mb-10">
        <TaskListWrap completeDateFilter={null} typeFilter={['Task']} missedFilter={false} title="Open Tasks" />
      </div>
      ...
      <div className="flex flex-col w-full h-full mb-10">
        <TaskListWrap completeDateFilter={null} typeFilter={['Task']} missedFilter={true} title="Missed Tasks" />
      </div>
    </main>
  );
}
