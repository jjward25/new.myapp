  ...
  return (
    <div className="flex flex-col w-full max-w-[1000px] ">
      <button
        ...
        className={`btn text-sm mx-0 border-cyan-950 bg-cyan-950 hover:border-cyan-200 text-white btn-secondary hover:bg-cyan-950 hover:text-cyan-300 w-auto max-w-[1000px]`}
      >
