...
export default function Navbar() {
    return (
            <nav id="app-nav" className="flex justify-between items-center md:px-20 md:py-3 md:pt-6 sticky top-0 z-50">
                <div className="cursor-pointer relative rounded-bl-md rounded-br-md md:rounded-lg w-full overflow-hidden md:my-1 h-full">
                    <div className="nav-blur absolute -inset-3  bg-gradient-to-tr from-cyan-300 via-neutral-300 to-cyan-300 dark:bg-black blur opacity-90"></div>
                    <div className="nav-bar relative rounded-bl-lg rounded-br-lg md:rounded-lg flex justify-around border-2 border-cyan-200">
